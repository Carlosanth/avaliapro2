    ...
    <div class="no-print" style="display:flex; justify-content:flex-end; gap:8px; margin-top:16px">
      ${!av.semServico && (sit === 'reprovado' || sit === 'parcial') ? (
        av.notificadoEm
          ...
          : `<button class="btn btn-primary" onclick="notificarFornecedorNota('${av.id}')" style="margin-right:auto; display:inline-flex; align-items:center; gap:6px">${ic('mail', 13)}Notificar por e-mail</button>`
      ) : ''}
